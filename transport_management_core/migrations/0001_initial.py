    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "vehicle_type",
                    models.CharField(
                        choices=[("truck", "truck"), ("van", "van")], max_length=5
                    ),
                ),
                (
                    "max_capacity",
                ...
                (
                    "cost_per_km",
                    models.FloatField(help_text="Cost of transport in €/km"),
                ),
                ("is_available", models.BooleanField()),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="transport_management_core.vehicle",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "weight",
                    models.FloatField(help_text="Total weight of the load in kg"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="transport_management_core.driver",
                    ),
                ),
                (
                    "vehicle",
